...
import { initialValues, validationSchema } from "../schema/participants_schema";
...
const AddParticipantForm = ({
  ...
  const mutation = useMutation({
    mutationFn: (formData: Participant) => {
      const token = user?.token;
      const postData: Participant = {
        ...formData,
        isEtudiants,
        isSpeakers,
        isParticipants,
      ...
      return axios.post(
        `${BASE_URL}/organisations/allParticipants/`,
        postData,
        {
          headers: {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      resetForm();
      setIsPriseEnChargeBillet(false);
    },
  });
